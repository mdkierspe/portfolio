<section aria-label="Home Hero" class="relative">
    <div class="container">
      <div class="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
        <svg viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true" class="absolute inset-y-0 right-8 hidden h-full w-80 translate-x-1/2 transform lg:block fill-gray-900">
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-gray-800">
